...
export default function Home() {
  return (
    <main className="w-full h-full flex flex-col sm:overflow-hidden text-lg bg-blue-200 sm:flex-row md:bg-red-200">
      <div className=" h-full w-screen grid place-items-center md:place-items-start md:pl-20 pt-3 sm:pt-12 sm:w-1/2">
